...
public class UserEmpruntModificationInterface {
    ...
    public UserEmpruntModificationInterface(int empruntId) {
    ...
    public static void main(String[] args) {
        ...
        UserEmpruntModificationInterface empruntModificationInterface = new UserEmpruntModificationInterface(empruntId);
